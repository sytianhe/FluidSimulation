...
\item Continue...
\end{enumerate}  
See the  main program \textbf{Seed Drop} for implementation details, or to try it out for yourself.    
...
Just for fun, we provide a few plots of our data in Fig~1 and Fig~2.  As hinted at above, both plots indicate a transition point in behavior near eccentricity of 0.5.  In the first plot, 

\begin{widepage}
\begin{figure}
\begin{center}
\includegraphics[width=300pt]{fig1.jpg}
\caption{default}
\label{default}
\end{center}
\end{figure}
...
For lack of time, we will only provide a cursory analysis of the data obtained.  (But perhaps we will have more to say on Thursday).      


\section{Conclusion}
We have described a simulation based approach  for quantifying the aerodynamics of random 2D shapes.  In the context of plan seed dispersoin, this approach provides for an (approximate) global understanding of the fitness landscape for seed morphology.  While we only present preliminary results as  proof of concept, it is our ho[e that  extensions of this  approach will provide new understanding of seed morphology, dispersal, population dynamics, and evolution.
